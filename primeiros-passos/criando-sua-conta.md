...
Na tela de acesso, toque em **Entrar com Google** e escolha sua conta. Pronto — sem senha para criar ou lembrar. É o caminho mais rápido, tanto para cadastrar sua locadora quanto no dia a dia.

{% hint style="success" %}
**O acesso é imediato.** Não chega e-mail de confirmação para você liberar — você já entra no sistema pronto para usar.
{% endhint %}

## Entrar com e-mail e senha (alternativa)
