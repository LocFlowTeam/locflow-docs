---
icon: book
description: Os termos do LocFlow em linguagem simples — orçamento, reserva, separação, conferência, parcela, canal e mais. Consulte sempre que bater dúvida.
---

# Glossário do LocFlow

Os termos que você vê pelo sistema, explicados em uma linha. Bateu dúvida em alguma tela? Volte aqui.
...
| Termo | O que é |
| --- | --- |
| **Fatura** | A cobrança do pedido; nasce automática ao ganhar o orçamento. |
...
| **Pagamento online** | Link de pagamento (PIX/cartão/boleto) com baixa automática. |
| **Crédito / vale-locação** | Valor a favor do cliente que vira crédito para a próxima locação. |
| **Reembolso** | Devolução do valor ao cliente (estorno ou transferência). |
...
| **Competência** | A **habilidade** ligada à função (Dirigir veículos, Vender orçamentos, Separação, Conferência). |
...
| **Pool** | De onde saem os destinatários: organização, competência, responsável, cliente. |
...
## Configuração e frota

| Termo | O que é |
| --- | --- |
| **Motor** | Uma regra da sua operação que o sistema segue sozinho (frete, cobrança, logística, estoque, orçamento). |
| **Bloqueio de estoque** | A janela em que um item fica reservado e indisponível para outro cliente. |
