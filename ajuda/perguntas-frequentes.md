---
icon: comments
description: Respostas rápidas para as dúvidas mais comuns do dia a dia — orçamento, pré-reserva, separação, pagamento, papéis e créditos.
---
...
Você convida por um **link** — esse link é a credencial, não pedimos e-mail nem senha. Marque um ou mais **papéis prontos** (Motorista, Separador, Conferente…) e mande o link pela pessoa. Veja [Colaboradores e acessos](../configuracoes/colaboradores-e-acessos.md).
