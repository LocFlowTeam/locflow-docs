---
icon: truck
description: A experiência de quem entra pelo convite — o espaço só seu, as solicitações de repasse, os ganhos, a reputação e o caminho para virar org↔org.
---
...
Esta página fala principalmente **com você, parceiro**: o que você encontra ao entrar, como decidir sobre um repasse, onde acompanhar os seus ganhos e a sua reputação — e o caminho para crescer na rede. Se você é a locadora e quer **convidar** alguém, o passo a passo do convite está em [Entrando na rede](entrando-na-rede.md); e o que você vê do seu lado ao repassar está em [Repassando um pedido](repassando-um-pedido.md).

## Você, dentro da conta de quem te convidou {#o-que-e}

Ser parceiro externo é diferente de ser um colaborador e diferente de ter uma empresa no LocFlow:

- Você **não é um funcionário** da locadora — não entra na equipe dela, não recebe permissões configuráveis. O seu papel é **fixo**: parceiro logístico.
- Você **não precisa de organização própria** — o seu acesso vive dentro da conta de quem te convidou, numa **caixa isolada**.
...
Antes de qualquer repasse existe um **acordo** entre você e a locadora: quais itens você atende, **quanto você recebe por cada um**, o gatilho de pagamento, o prazo que você tem para aceitar uma solicitação e a janela para desistir sem marca. O acordo é uma **conversa de ida e volta** — pode ser proposto por qualquer um dos lados, e você pode **aprovar, rejeitar ou contra-propor** até as duas partes ativarem.

O ciclo completo do acordo — termos, aprovação bilateral, frete manual ou por motor — está em [Acordos de parceria](acordos-de-parceria.md). Para esta página, o que importa é: **tudo o que você vê nas solicitações nasce do acordo** — o valor do seu repasse, o prazo de aceite, a janela de desistência.

## As solicitações de repasse {#solicitacoes}

Quando a locadora fecha um pedido e repassa a operação para você, chega uma **solicitação** — você recebe uma notificação e a reserva aparece com o convite claro: *"Toque para revisar e decidir"*.
...
O acordo pode definir uma **antecedência mínima**: a solicitação precisa ser aceita até certo momento antes da operação. Enquanto ela está aberta, o app mostra o limite exato — *"Aceite até 14/08 às 10:00 para assumir esta operação"*, por exemplo.

Se o prazo estoura sem resposta, a solicitação **expira sozinha**: você não consegue mais aceitá-la, a locadora fica livre para repassar a outro parceiro e a expiração entra como **penalidade leve** no seu [índice de confiabilidade](#indice-de-confiabilidade).

{% hint style="warning" %}
**Não deixe solicitação apodrecer.** Se você já sabe que não vai fazer, **recuse com o motivo** — sai limpo para os dois lados. Deixar o prazo estourar em silêncio trava a operação da locadora e desconta do seu índice.
{% endhint %}
...
| --- | --- |
| **Dentro da janela** | É um direito seu. A operação volta para a locadora, sem marca no seu índice. |
| **Depois do limite (tardia)** | A desistência é registrada como **tardia** — penalidade média no índice. O app avisa **antes** de você confirmar. |
...
A tela mostra a sua **nota**, a quantidade de avaliações, a **distribuição** (quantas de 5★, de 4★...) e o seu **selo** — Novo, Bronze, Prata, Ouro ou Diamante, conforme o histórico cresce. A nota exibida é uma **média ponderada** (recência e valor da operação) que resiste a poucas avaliações: uma nota ruim isolada não te derruba, e ela se aproxima da sua média real conforme você acumula histórico. Enquanto não há avaliações, a tela diz *"Novo por aqui"* — cada operação bem-feita constrói a sua reputação.

Essas estrelas têm efeito prático: elas alimentam o **ranking** que a locadora vê ao escolher para quem repassar. Reputação boa = mais operações chegando para você.

### Índice de confiabilidade {#indice-de-confiabilidade}

Separado das estrelas existe o **índice de confiabilidade**: um número de **0 a 100** que começa em **100** e só cai com falhas **objetivas** — não é opinião, é registro:
...
Levou uma penalidade injusta — o cliente não estava no local, o prazo estourou por um problema que não era seu? Cada penalidade vigente tem o botão **Contestar**: você descreve o motivo e ela entra **em análise**. Enquanto está sendo analisada, **a penalidade sai do cálculo do índice** — você não carrega a marca durante a discussão. Se a contestação for acolhida, a penalidade é **anulada** de vez.
...
- [Pagamento online](../cobranca/pagamento-online.md) — o cadastro de recebedor, que também vale para o seu repasse.
